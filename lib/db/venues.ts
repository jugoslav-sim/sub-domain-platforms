...
export const venueService = {
    ...
    update: async (id: string, updates: UpdateVenue) => {
        const { data, error } = await supabase
            .from('venues')
            .update(updates)
            .eq('id', id)
    ...
    updateConfig: async (id: string, configType: 'profile_data' | 'hero_data' | 'branding_data' | 'layout_data' | 'seo_data' | 'location_data' | 'hours_data' | 'social_data' | 'music_data', data: any) => {
