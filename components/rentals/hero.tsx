                ...
                <div className="flex flex-col lg:flex-row items-center gap-12">
                    ...
                    <div className="flex-1 space-y-8">
                        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight">
                            Unlock New Revenue Streams. Showcase Your Space.
                        </h1>
                        <p className="text-xl text-gray-600 max-w-xl">
                            Create a place where clients can explore, book, and pay for your private event spaces. From intimate VIP booths to full-venue takeovers, showcase every rental option beautifully.
                        </p>
                        <Button
                            size="lg"
