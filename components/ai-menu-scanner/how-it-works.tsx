    ...
    const steps = [
        {
            ...
            description: 'Use your phone or upload an existing image of your menu. Clear, well-lit photos work best.',
        },
        {
            icon: Sparkles,
            title: '2. AI Scans & Extracts',
            description: 'Our AI instantly analyzes the image, identifying categories, items, descriptions, and prices.',
        },
        {
            icon: CheckCircle2,
            title: '3. Review & Publish',
            description: 'Your digital menu is ready. Quickly review the extracted items and publish them to your live page.',
        },
    ];
