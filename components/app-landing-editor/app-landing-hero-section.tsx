...
import { ImageUpload } from '@/components/venue-editor/image-upload'; // Reusing existing component
import { AppLandingEditorData } from '@/lib/app-landing-editor-schema';

export function AppLandingHeroSection() {
    const { register, watch, setValue } = useFormContext<AppLandingEditorData>();
